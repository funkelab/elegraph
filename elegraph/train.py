...
# make sure experiments directory has 'test-00x' directory and train_parameters.py before running
...
def train(num_iterations):
    ...
    # create loss
    loss = Loss(
        path=os.path.join('/groups/funke/home/tame/experiments/', experiment_name, 'train_loss.csv'),
        weight_fg=weight_fg,
    ...
    if not os.path.exists('/groups/funke/home/tame/experiments/' + experiment_name):
        os.makedirs('/groups/funke/home/tame/experiments/' + experiment_name, exist_ok=True)
    if not os.path.exists('/groups/funke/home/tame/experiments/' + experiment_name + '/models/'):
        os.makedirs('/groups/funke/home/tame/experiments/' + experiment_name + '/models/', exist_ok=True)
    if not os.path.exists('/groups/funke/home/tame/experiments/' + experiment_name + '/snapshots/'):
        os.makedirs('/groups/funke/home/tame/experiments/' + experiment_name + '/snapshots/', exist_ok=True)
    ...
    pipeline = (
        ...
        + gp.torch.Train(
            ...
            checkpoint_basename=os.path.join('/groups/funke/home/tame/experiments', experiment_name, 'models/model'), 
        )
        ...
        + gp.Snapshot(
            ...
            output_dir=os.path.join('/groups/funke/home/tame/experiments', experiment_name, 'snapshots'), 
